...
import { createDefaultMetadata, getMetadata, putMetadata } from "./metadata.js";
import { allocateShortId, isShortUrlsEnabled, putShortLink } from "./shortlink.js";
import { getProviderByName, getUploadProvider, r2Provider } from "../storage/index.js";
import { dedupKey, deleteDedupEntry, getDedupEntry, hashFileContent, putDedupEntry } from "./dedup.js";
...
// 图床上传核心逻辑（不含鉴权），供 POST /upload 与 POST /api/imgbed/upload 共用。
// 返回统一 JSON：成功为 [{src, ...}] 数组，失败为 {error} JSON。
